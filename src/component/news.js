    ...
    return (
        <div className="container">
            ...
            <div className="tab-content">
                {activeTab === 0 && (
                    <div>
                        <h1>China Box Office: ‘Spider-Man: Across The Spider-Verse’ Opens to So-So $17.2M</h1>
                ...
                {activeTab === 1 && (
                    <div>
                        <h1>Studio Ghibli to Release Hayao Miyazaki’s Final Film ‘How Do You Live?’ With No Trailer, No Promotional Marketing</h1>
                        ...
                        <img src='picture/1/news2,5.jpg' />
                    </div>
                )}

                {activeTab === 2 && (
                    <div>
                        <h1>Gkids, Studio Ghibli Ink Home Entertainment Deal</h1>
                        <h4>The first releases will include 'Princess Mononoke' and Oscar winner 'Spirited Away.'</h4>
                        <img src='picture/1/news3.jpg' />
